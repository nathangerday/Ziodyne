...
public class DistributedCVM extends AbstractDistributedCVM{
	...
	public void instantiateAndPublish() throws Exception{
		if(this.thisJVMURI.equals(URI.JVM_CONTROLLER)) {
		...
		else if (this.thisJVMURI.equals(URI.JVM_LAMP)) {
		...
		else if (this.thisJVMURI.equals(URI.JVM_FRIDGE)) {
		...
		else if (this.thisJVMURI.equals(URI.JVM_WINDTURBINE)) {
		...
		else if (this.thisJVMURI.equals(URI.JVM_DISHWASHER)) {
		...
		else if (this.thisJVMURI.equals(URI.JVM_ELECTRICMETER)) {
		...
		else if (this.thisJVMURI.equals(URI.JVM_BATTERY)) {
